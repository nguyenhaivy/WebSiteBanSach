			...
			<div class="row align-items-center">
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form id="siginform" action="../controller/UserController.php" method="post">
							<div class="input-group custom">
								<input id="email" type="text" name="email" class="form-control form-control-lg" placeholder="Username" required>
